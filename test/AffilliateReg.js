...
describe('AffiliateReg', () => {
  ...
  it('should have correct owner for "aff2"', () => {
    return affiliateReg.getAffiliateOwner.q('aff2').should.eventually.equal(chaithereum.accounts[2])
  })

  it('should have correct coinbase for "aff2"', () => {
    return affiliateReg.getAffiliateCoinbase.q('aff2').should.eventually.equal(chaithereum.accounts[3])
  })
  ...
  it('should have correct owner for "aff"', () => {
    return affiliateReg.getAffiliateOwner.q('aff').should.eventually.equal(chaithereum.accounts[2])
  })

  it('should have correct coinbase for "aff"', () => {
    return affiliateReg.getAffiliateCoinbase.q('aff').should.eventually.equal(chaithereum.accounts[3])
  })
})
